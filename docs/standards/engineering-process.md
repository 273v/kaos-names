...
This document defines how `kaos-names` handles features, bugs,
...
- What `kaos-names` version, platform, Python version, and installation
  method are involved?
...
- Fresh install smoke test that imports `kaos_names`.
