...
`kaos-names` requires Python 3.13 or newer. It publishes the `kaos_names`
import package. This package publishes CLI entry point(s): `kaos-names`.
...
include the `kaos-names` version, Python version, operating system,
